...
static int balance_dirty_pages(struct bdi_writeback *wb,
			       unsigned long pages_dirtied, unsigned int flags, struct inode *inode)//added inode scorw
{
...
//// scorw end////
                ...
                //// scorw end////
                        ...
                        //wb->dirty_sleep = now; Rajan removed...patch... new kernel redundant
...
//		ret = balance_dirty_pages(wb, current->nr_dirtied, flags);
                ret= balance_dirty_pages(wb, current->nr_dirtied,flags, inode);    //scorw start, scorw end. modified the balance_dirty_pages() to pass inode as parameter.
	wb_put(wb);
	return ret;
}
